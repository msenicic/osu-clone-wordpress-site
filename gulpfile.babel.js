...
/**
 * selune Theme
 * Copyright 2019 selune. All rights reserved.
 */
...
const
    themeRoot = 'wp-content/themes/selune',
    ...
    banner = ['/**',
        ...
        ' * @license <%= pkg.license %>',
        ' * @copyright 2021 selune',
        ' * @link https://selune.io',
        ' */',
        ''].join('\n'),
    ...
    SOURCES = [
        srcRoot + '/scripts/src/jquery.js',
        srcRoot + '/scripts/src/slick.js',
        srcRoot + '/scripts/src/fancy-box.js',
        srcRoot + '/scripts/src/script.js'
    ];

gulp.task('mocha', () => {
    return gulp.src(srcRoot + '/scripts/test/**/*.js', { read: false })
...
gulp.task('styles:dev', gulp.series('sass-lint', () => {
...
// TODO Set proper config.domain (in package.json) ex: domain-dev.local.com
gulp.task('serve', () => {
    browserSync.init({
        open: 'false',
