<?php
/**
 * Custom meta functions for selune
 ...
 */
function get_selune_excerpt($field, $count = '', $end = '') {;
 ...
 * @param $field - ACF field with content to do excerpt
 */
function the_selune_excerpt($field, $count = '', $end = '') {
    echo get_selune_excerpt($field, $count, $end);
}
